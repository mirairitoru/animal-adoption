        ...
        <div class="flex flex-col items-center justify-center">
            ...
            <div class="flex mb-6">
                <button id="btn-user" type="button" onclick="setRole('user')"
                    class="border p-1 w-48 text-white !bg-green-700 bg-gray-200">一般ユーザー</button>
            ...
            <div id="user-fields" class="w-96">
                ...
                <div class="w-96">
                    ...
                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="user_name"
                        :value="old('user_name')" required autofocus autocomplete="user_name" placeholder="山田 太郎" />
                ...
                <div class="mt-4 w-96">
                    ...
                    <x-text-input id="nickname" class="block mt-1 w-full" type="text" name="nickname"
                        :value="old('nickname')" required autofocus autocomplete="name" placeholder="ニックネーム" />
            ...
            <div class="mt-4 w-96">
                ...
                <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email')"
                    required autocomplete="username" placeholder="メールアドレス" />
            ...
            <div class="mt-4 w-96">
                ...
                <x-text-input id="password_confirmation" class="block mt-1 w-full" type="password"
                    placeholder="確認用パスワード" name="password_confirmation" required autocomplete="new-password" />
